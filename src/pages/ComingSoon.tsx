  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative">
      ...
      <div className="fixed top-16 left-0 right-0 bottom-0 z-[2] md:hidden pointer-events-none">
        ...
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 rotate-10 w-4 h-88 bg-gradient-to-b from-yellow-400/12 via-yellow-400/6 to-transparent blur-lg animate-pulse"
        ...
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 rotate-20 w-3 h-80 bg-gradient-to-b from-yellow-400/10 via-yellow-400/5 to-transparent blur-lg animate-pulse"
        ...
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 rotate-35 w-2 h-76 bg-gradient-to-b from-yellow-400/8 via-yellow-400/4 to-transparent blur-lg animate-pulse"
        ...
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 rotate-50 w-2 h-72 bg-gradient-to-b from-yellow-300/7 via-yellow-300/3 to-transparent blur-lg animate-pulse"
        ...
        <div
          className="absolute top-0 left-1/2 transform -translate-x-1/2 rotate-65 w-1 h-68 bg-gradient-to-b from-yellow-300/6 via-yellow-300/2 to-transparent blur-lg animate-pulse"
      ...
      <div
        className="fixed top-16 left-0 right-0 bottom-0 z-[15] pointer-events-none md:hidden"

    ...
    <div className="min-h-screen bg-white/80 backdrop-blur-sm relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 max-w-7xl mx-auto">
          ...
          <div className="absolute inset-0 -z-10">
            <div className="w-full h-32 bg-gradient-to-r from-blue-400/20 via-green-400/20 to-purple-400/20 rounded-3xl blur-2xl opacity-60"></div>
          </div>
          
          {/* Header Content */}
          <div className="relative bg-white/20 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-white/10 shadow-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-green-900 dark:from-white dark:via-blue-100 dark:to-green-100 bg-clip-text text-transparent mb-4">
              Document Submission
            </h1>
            <p className="text-lg text-gray-700/80 dark:text-gray-300/80 font-medium leading-relaxed">
              Secure upload with instant NIC verification
            </p>
            
            {/* Status Indicators */}
            <div className="flex items-center justify-center mt-6 space-x-6">
              <div className="flex items-center text-sm text-gray-600/70 dark:text-gray-400/70">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/30 dark:bg-white/5 backdrop-blur-2xl rounded-3xl p-8 md:p-12 border border-white/20 dark:border-white/10 shadow-2xl shadow-black/5 dark:shadow-black/20">
            ...
            <div className="relative group/input">
              ...
              {/* Enhanced Help Text */}
              <div className="mt-4">
                <div className="bg-white/30 dark:bg-white/5 backdrop-blur-xl rounded-xl p-4 border border-white/20 dark:border-white/10">
                  <div className="flex items-center justify-between">
                    <p
                      id="nic-help"
                    ...
                    >
                      {nic.length === 0
                        ...
                        : nic.length < 12
                        ? `${12 - nic.length} digits remaining`
                        : isValidatingNic
                        ? "Validating NIC..."
                        : isNicValid === true
                        ...
                        : "NIC ready for validation"}
                    </p>
                    
                    {/* Progress Bar */}
                    <div className="ml-4 flex items-center space-x-2">
                      <div className="w-20 bg-gray-200/50 dark:bg-gray-700/50 rounded-full h-1.5">
                        <div 
...
// ============================================================================
// TEST IDEAS (for future implementation)
// ============================================================================

/*
Test scenarios to consider:

1. NIC Validation Tests:
   - Should accept only numeric input
   - Should limit input to 12 characters
   - Should validate NIC when exactly 12 digits are entered
   - Should show loading state during validation
   - Should handle API success and fallback scenarios
...
2. File Upload Tests:
   ...
   - Should reject non-PDF files with appropriate message

3. Form Submission Tests:
   - Should disable submit button when requirements not met
   - Should enable submit button when all requirements satisfied
   - Should handle successful upload response
...
5. Responsive Design Tests:
   - Should work on mobile (320px) and desktop (1024px+)
   - Should adapt layout appropriately
   - Should maintain usability across screen sizes

6. Dark Mode Tests:
   - Should respect system color scheme preference
   - Should apply appropriate dark mode styles
   - Should maintain contrast and readability
*/

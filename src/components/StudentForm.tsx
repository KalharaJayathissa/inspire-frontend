...
const StudentRegistrationForm = () => {
  ...
  const handleInputChange = (
    ...
    setFormData((prev) => {
      ...
      // Always set school to "Other" and exam location to "external-kegalle"
      newData.school = "Other";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "🎉 Registration submitted successfully! Welcome to KESS Inspire 2025!",
        {
          duration: 3000,
        }
      );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-4 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-4xl mx-auto">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          {/* Header */}
          <div
            className="text-center mb-6 sm:mb-8 lg:mb-8 xl:mb-10  
              ...
              <div>
                ...
                >
                  <option
                    value=""
                    disabled
                    className="text-gray-500 bg-white hover:bg-[#c7f7a1] hover:text-[#2D620A]"
                  >
                    Select Attempt
                  </option>
                  <option
                    value="1st"
                    className="text-gray-900 bg-white hover:bg-[#c7f7a1] hover:text-[#2D620A]"
                  >
                    1st Shy
                  </option>
                  <option
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <label className="flex items-center p-3 sm:p-4 border-2 rounded-lg cursor-pointer hover:bg-[#c7f7a1] hover:border-[#2D620A] transition-colors">
                      <input
                        ...
                        checked={
                          formData.subjectStream === "biological-science"
                        }
                        onChange={handleInputChange}
                        className="mr-3 text-[#2D620A] focus:ring-[#2D620A] focus:ring-offset-0 border-gray-300 w-4 h-4"
                        style={{ accentColor: "#2D620A" }}

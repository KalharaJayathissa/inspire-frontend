            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="1st" className="text-gray-900 bg-white">
                    1st Shy
                  </option>
                  <option value="2nd" className="text-gray-900 bg-white">
                    2nd Shy
                  </option>
                  <option value="3rd" className="text-gray-900 bg-white">
                    3rd Shy
                  </option>
                </select>
                {errors.shy && (
